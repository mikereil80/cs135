...
(define (wj-help fillA fillB maxA maxB goal)
  (cond ((eq? fillB goal) (list (list fillA fillB)))
        ((eq? fillB maxB) (cons (list fillA fillB) (wj-help fillA 0 maxA maxB goal)))
        ((eq? fillA 0) (cons (list fillA fillB) (wj-help maxA fillB maxA maxB goal)))
        ...
        ((eq? (+ fillA fillB) maxB) (cons (list fillA fillB) (wj-help 0 (+ fillA fillB) maxA maxB goal)))))
